...
class TrackerFragment : Fragment() {
    ...
    private val adapter = JuiceListAdapter(
        onEdit = { drink ->
            findNavController().navigate(TrackerFragmentDirections.actionTrackerFragmentToEntryDialogFragment(drink.id))
        },
        onDelete = { drink ->
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.fab.setOnClickListener { fabView ->
            fabView.findNavController().navigate(TrackerFragmentDirections.actionTrackerFragmentToEntryDialogFragment())
        }
